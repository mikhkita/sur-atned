$(document).ready(function (){
	...
	function mainfMobile (){		
		...
		for (var i = itemslen-1; i >= 0; i--) {
			$('.doc-'+(i+1)+'').wrap('<div class = "doctwrap" data-fancybox data-src="#doc-1" href="javascript:;"></div>');
...
//data-fancybox data-src="#doc-1" href="javascript:;"